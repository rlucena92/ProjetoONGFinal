...
public class PanelManterFuncionarioView extends AbstractPanel {
	 ...
	 * Create the panel.
	 */
	public PanelManterFuncionarioView() {
		...
		btnCadastrar.addActionListener(event -> {
			...
			login.setPerfilAcessoEnum(PerfilAcessoEnum.FUNCIONARIO);
	...
	private void carregarPessoas() {
		...
		List<Pessoa> pessoas = AcessoController.getInstance().carregarPessoas(PerfilAcessoEnum.FUNCIONARIO);
		    ...
		    public void mouseClicked(java.awt.event.MouseEvent evt) {
		    	...
		    	if(table.columnAtPoint(evt.getPoint()) == 5) {
		    		...
		    		int input = JOptionPane.showConfirmDialog(null, 
		    				"Deseja realmente excluir o registro?", "Selecione uma opção...", JOptionPane.YES_NO_OPTION);
